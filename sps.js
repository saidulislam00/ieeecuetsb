...
const canvas = document.getElementById("spsParticles"); // ID changed
...
function resize() {
    ...
    height = canvas.height = document.getElementById("sps-hero").offsetHeight; // ID changed
}
...
class Wave {
    constructor(index) {
        ...
        // SPS Cyan Color
        this.color = `rgba(0, 229, 255, ${0.15 + Math.random() * 0.25})`; 
    }
